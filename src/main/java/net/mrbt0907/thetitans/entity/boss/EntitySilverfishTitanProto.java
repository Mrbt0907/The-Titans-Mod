...
public class EntitySilverfishTitanProto extends EntityPreTitan
{
	...
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_SILVERFISH_AMBIENT : SoundRegistry.get("titan.silverfish.living");
	}
	
	protected SoundEvent getHurtSound(DamageSource source)
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_SILVERFISH_HURT : SoundRegistry.get("titan.silverfish.grunt");
	}
	
	protected SoundEvent getDeathSound()
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_SILVERFISH_DEATH : SoundRegistry.get("titan.silverfish.death");
	}
	...
	{
		double hp = 2000D * this.getSizeMultiplier();
	...
	{
		double attack = 10D * this.getSizeMultiplier();
