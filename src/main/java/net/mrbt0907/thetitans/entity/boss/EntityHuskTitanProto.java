...
public class EntityHuskTitanProto extends EntityPreTitan
{
	...
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_HUSK_AMBIENT : SoundRegistry.get("titan.zombie.living");
	}
	
	protected SoundEvent getHurtSound(DamageSource source)
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_HUSK_HURT : SoundRegistry.get("titan.zombie.grunt");
	}
	
	protected SoundEvent getDeathSound()
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_HUSK_DEATH : SoundRegistry.get("titan.zombie.death");
	}
	
	protected void playStepSound(BlockPos pos, Block blockIn)
	{
		playSound(this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? (this.getSizeMultiplier()  > 2 ? SoundEvents.ENTITY_HUSK_STEP : SoundEvents.ENTITY_HUSK_STEP) : SoundRegistry.get("titan.step"), this.getSoundVolume(), this.getSoundPitch());
	}
