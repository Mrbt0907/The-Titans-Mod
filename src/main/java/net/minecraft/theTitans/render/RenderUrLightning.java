...
public class RenderUrLightning extends RenderLightningBolt
{
	public RenderUrLightning()
	{
		this.shadowSize = 0F;
	}
		...
		for (int k1 = 0; k1 < 4; ++k1)
		{
			...
			for (int j = 0; j < 3; ++j)
			{
				...
				for (int i1 = k; i1 >= l; --i1)
				{
					...
					tessellator.setColorRGBA_F(new Random().nextFloat(), new Random().nextFloat(), new Random().nextFloat(), 1F);
