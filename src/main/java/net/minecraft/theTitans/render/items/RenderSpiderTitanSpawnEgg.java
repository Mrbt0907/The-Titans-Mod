...
public class RenderSpiderTitanSpawnEgg implements IItemRenderer
{
	public static final ResourceLocation[] EGG_TEXTURE_LIST = new ResourceLocation[]
	{
		new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spidertitan/spider_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spidertitan/test_spider_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spidertitan/mycelium_spider_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spidertitan/lunar_spider_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spidertitan/void_spider_titan_egg.png"))
	};
	
	ModelTitanSpawnEgg eggmodel;
	public RenderSpiderTitanSpawnEgg()
	{
