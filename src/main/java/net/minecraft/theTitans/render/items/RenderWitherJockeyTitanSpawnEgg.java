...
public class RenderWitherJockeyTitanSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/wither_jockey_titan_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderWitherJockeyTitanSpawnEgg()
	{
