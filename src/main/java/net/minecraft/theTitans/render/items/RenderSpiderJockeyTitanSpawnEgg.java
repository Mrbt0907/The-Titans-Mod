...
public class RenderSpiderJockeyTitanSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/spider_jockey_titan_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderSpiderJockeyTitanSpawnEgg()
	{
