...
public class RenderGargoyleKingSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/gargoyle_king_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderGargoyleKingSpawnEgg()
	{
