...
public class RenderSnowGolemTitanSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/snow_golem_titan_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderSnowGolemTitanSpawnEgg()
	{
