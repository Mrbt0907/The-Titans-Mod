...
public class RenderGhastTitanSpawnEgg implements IItemRenderer
{
	public static final ResourceLocation[] EGG_TEXTURE_LIST = new ResourceLocation[]
	{
		new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/ghasttitan/ghast_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/ghasttitan/lightning_ghast_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/ghasttitan/obsidian_ghast_titan_egg.png"))
	};
	
	ModelTitanSpawnEgg eggmodel;
	public RenderGhastTitanSpawnEgg()
	{
