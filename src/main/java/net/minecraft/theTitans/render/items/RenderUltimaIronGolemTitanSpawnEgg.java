...
public class RenderUltimaIronGolemTitanSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/ultima_iron_golem_titan_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderUltimaIronGolemTitanSpawnEgg()
	{
