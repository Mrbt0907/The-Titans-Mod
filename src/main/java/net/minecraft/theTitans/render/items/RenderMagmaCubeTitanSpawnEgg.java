...
public class RenderMagmaCubeTitanSpawnEgg implements IItemRenderer
{
	private static final ResourceLocation eggTextures = new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/magma_cube_titan_egg.png"));
	ModelTitanSpawnEgg eggmodel;
	public RenderMagmaCubeTitanSpawnEgg()
	{
