...
public class RenderCreeperTitanSpawnEgg implements IItemRenderer
{
	public static final ResourceLocation[] EGG_TEXTURE_LIST = new ResourceLocation[]
	{
		new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/creepertitan/creeper_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/creepertitan/hell_creeper_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/creepertitan/ghost_creeper_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/creepertitan/ender_creeper_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/creepertitan/void_creeper_titan_egg.png"))
	};
	
	ModelTitanSpawnEgg eggmodel;
	public RenderCreeperTitanSpawnEgg()
	{
