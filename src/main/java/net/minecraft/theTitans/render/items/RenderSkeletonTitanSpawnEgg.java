...
public class RenderSkeletonTitanSpawnEgg implements IItemRenderer
{
	public static final ResourceLocation[] EGG_TEXTURE_LIST = new ResourceLocation[]
	{
		new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/skeletontitan/skeleton_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/skeletontitan/sand_skeleton_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/skeletontitan/guitar_skeleton_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/skeletontitan/sleepy_skeleton_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/skeletontitan/void_skeleton_titan_egg.png"))
	};
	
	ModelTitanSpawnEgg eggmodel;
	public RenderSkeletonTitanSpawnEgg()
	{
