...
public class RenderZombieTitanSpawnEgg implements IItemRenderer
{
	public static final ResourceLocation[] EGG_TEXTURE_LIST = new ResourceLocation[]
	{
		new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/zombietitan/zombie_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/zombietitan/jungle_zombie_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/zombietitan/blood_zombie_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/zombietitan/radiation_zombie_titan_egg.png")),new ResourceLocation(TheTitans.getTextures("textures/entities", "eggs/zombietitan/void_zombie_titan_egg.png"))
	};
	
	ModelTitanSpawnEgg eggmodel;
	public RenderZombieTitanSpawnEgg()
	{
