...
public class ModelEvilGolem extends ModelBase
{
	public ModelRenderer ironGolemHead;
	public ModelRenderer ironGolemHead2;
	public ModelRenderer ironGolemBody;
	public ModelRenderer ironGolemRightArm;
	public ModelRenderer ironGolemLeftArm;
	public ModelRenderer ironGolemLeftLeg;
	public ModelRenderer ironGolemRightLeg;
	public boolean hasSmallerHead;
	public ModelEvilGolem(float p_i1162_1_, float p_i1162_2_)
	{
		short short1 = 128;
		short short2 = 128;
		...
		this.ironGolemHead2 = (new ModelRenderer(this)).setTextureSize(short1, short2);
		this.ironGolemHead2.setRotationPoint(0.0F, 0.0F + p_i1162_2_, -2.0F);
		this.ironGolemHead2.setTextureOffset(0, 0).addBox(-4.0F, -10.0F, -5.5F, 8, 8, 8, p_i1162_1_);
	...
	*/
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
	{
		...
		this.ironGolemHead2.render(p_78088_7_);
	...
	*/
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
	{
		...
		this.ironGolemHead2.rotateAngleY = p_78087_4_ / (180F / (float)Math.PI);
		this.ironGolemHead2.rotateAngleX = p_78087_5_ / (180F / (float)Math.PI);
		...
		if (hasSmallerHead)
		{
			this.ironGolemHead.isHidden = true;
			this.ironGolemHead2.isHidden = false;
		}

		else
		{
			this.ironGolemHead2.isHidden = true;
			this.ironGolemHead.isHidden = false;
		}
	}
	...
	*/
	...
	{
		EntityEvilGolem entityirongolem = (EntityEvilGolem)p_78086_1_;
