...
{
	public ItemDemontiumArmor(String materialName, ItemArmor.ArmorMaterial material, int type, float titanArmor, float titanResistance)
	{
	...
	{
		if (soundTicks % 80 == 0)
		if (TheTitans.equippedAll(entity, TitanItems.demontiumArmorSet))
		SoundHandler.playSoundAttatched(entity, "thetitans:harcadiumHum", 0.25F, 1.30F, 119);
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if (TheTitans.equipped(player, TitanItems.demontiumHelmet, 1))
		{
		...
		else if (TheTitans.equipped(player, TitanItems.demontiumLeggings, 3))
		{
		...
		else if (TheTitans.equipped(player, TitanItems.demontiumBoots, 4))
		{
		...
		if (TheTitans.equippedAll(player, TitanItems.demontiumArmorSet))
		{
			player.extinguish();
