...
public class ItemWithireniumSpade
extends ItemNormalSpade
{
	public ItemWithireniumSpade(String unlocalizedName, Item.ToolMaterial material)
	{
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker)
	{
		...
		if (target != null)
		{
			...
			{
				target.attackEntityFrom(DamageSourceExtra.causeAntiTitanDamage(attacker), 600.0F);
