...
public class ItemWithireniumPickaxe
extends ItemNormalPickaxe
{
	public ItemWithireniumPickaxe(String unlocalizedName, Item.ToolMaterial material)
	{
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker)
	{
		...
		if (target != null)
		{
			...
			{
				target.attackEntityFrom(DamageSourceExtra.causeAntiTitanDamage(attacker), 650.0F);
