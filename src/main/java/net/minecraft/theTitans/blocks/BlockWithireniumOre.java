...
public class BlockWithireniumOre
extends BlockNormalOre
{
	public BlockWithireniumOre(String name)
	{
		this(null, name);
	}

	public BlockWithireniumOre(Block base, String name)
	{
		super(base, name, 5, 50.0F, 2000.0F);
		setExpDrop(12000, 12000);
		setItemDropped(TitanItems.voidItem);
		setLightLevel(0.2F);
	...
	{
		return TitanItems.withirenium;
	}

	private Random rand = new Random();
	public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_)
	{
		return MathHelper.getRandomIntegerInRange(this.rand, 15, 50);
	}
	...
	private void func_150186_m(World p_150186_1_, int p_150186_2_, int p_150186_3_, int p_150186_4_)
	{
		...
		for (int l = 0; l < 6; l++)
		{
			...
			{
				p_150186_1_.spawnParticle("flame", d1, d2, d3, 0.0D, 0.0D, 0.0D);
			}
		}
	}
}
