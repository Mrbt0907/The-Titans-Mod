...
public class BlockTitanusOre
extends BlockNormalOre
{
	public static final Block.SoundType soundTypeVoid = new Block.SoundType("stone", 10.0F, 0.5F);
	public BlockTitanusOre(String name)
	{
		this(null, name);
	}

	public BlockTitanusOre(Block base, String name)
	{
		super(base, name, 1000, 800.0F, 6000000.0F);
	...
	*/
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
	{
		...
		p_149734_1_.playSound(p_149734_2_ + 0.5F, p_149734_3_ + 0.5F, p_149734_4_ + 0.5F, "thetitans:harcadiumBlockHum", 1.0F, 0.75F, false);
	}
