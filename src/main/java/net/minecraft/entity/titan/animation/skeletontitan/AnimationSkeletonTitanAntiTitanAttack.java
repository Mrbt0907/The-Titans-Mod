...
extends AIAnimation
{
	...
	public void updateTask()
	{
		...
		if (((this.entity.getAnimTick() == 12)) && (this.entity.getAttackTarget() != null))
		{
			...
			this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.boundingBox.expand(48.0D, 48.0D, 48.0D)));
			this.entity.attackChoosenEntity(this.entity.getAttackTarget(), f, i);
			if (entity.isArmored())
			{
				if (entity.isClient())
				this.entity.playSound("thetitans:titanStrike", 20.0F, 1.0F);
				this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(26.0D, 26.0D, 26.0D)));
				this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(26.0D, 26.0D, 26.0D)));
				this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(26.0D, 26.0D, 26.0D)));
			}
			...
			if ((list11 != null) && (!list11.isEmpty()))
			{
				for (int i1 = 0; i1 < list11.size(); i1++)
				{
					...
					if (this.entity.canAttackClass(entity1.getClass()))
					{
						...
						this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(16.0D, 16.0D, 16.0D)));
						this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(16.0D, 16.0D, 16.0D)));
						this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(16.0D, 16.0D, 16.0D)));
						this.entity.collideWithEntities(this.entity.pelvis, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(this.entity, this.entity.pelvis.boundingBox.expand(16.0D, 16.0D, 16.0D)));
					}
