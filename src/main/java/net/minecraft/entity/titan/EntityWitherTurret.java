...
implements IRangedAttackMob
{
	...
	public void onLivingUpdate()
	{
		...
		if ((list11 != null) && (!list11.isEmpty()) && (getAttackTarget() == null))
		{
			for (int i1 = 0; i1 < list11.size(); i1++)
			{
				...
				if (((entity instanceof EntityLivingBase)) && (entity != null) && (entity.isEntityAlive()) && (getAttackTarget() == null) && (canTargetEntity((EntityLivingBase)entity)) && (canEntityBeSeen(entity)) && (entity.posY + entity.getEyeHeight() >= this.posY + 6.0D))
				{
		...
		if (getAttackTarget() != null)
		{
			...
			if ((!getAttackTarget().isEntityAlive()) || (getAttackTarget().isDead) || (getAttackTarget().posY + getAttackTarget().getEyeHeight() < this.posY + 6.0D) || (getAttackTarget().getDistanceSqToEntity(this) > 10000.0D) || (!canEntityBeSeen(getAttackTarget())))
			{
	...
	private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_)
	{
		if (this.shootingTimer <= 0)
		{
			playSound("thetitans:turretShoot", 6.0F, 1.0F);
			...
			EntityHomingWitherSkull entitywitherskull = new EntityHomingWitherSkull(this.worldObj, this, d6, d7, d8);
			if (p_82209_8_)
			{
			...
			if (getAttackTarget() != null)
			{
				entitywitherskull.assginedEntity = getAttackTarget();
			}
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		if (((entity instanceof EntityLivingBase)) && (!isEntityInvulnerable()) && (entity.posY + entity.getEyeHeight() >= this.posY + 8.0D))
		{
	...
	protected void onDeathUpdate()
	{
		...
		if (!this.worldObj.isRemote)
		{
			playSound("thetitans:turretDeath", 6.0F, 1.0F);
