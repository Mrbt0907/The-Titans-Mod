...
public class EntityHarcadiumGolem extends EntityIronGolem
{
	public EntityHarcadiumGolem(World p_i1694_1_)
	{
		super(p_i1694_1_);
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(25000.0D);
	...
	*/
	...
	public boolean attackEntityAsMob(Entity p_70652_1_)
	{
		...
		float damage = 100 + this.rand.nextInt(400);
