...
public class EntitySpiderMinion extends EntitySpider implements IRangedAttackMob, ITemplar
{
	...
	public EntitySpiderMinion(World worldIn)
	{
		...
		this.targetTasks.addTask(0, new EntityAINearestTargetTitan(this, EntityLivingBase.class, 0, false, false, ITitan.SpiderTitanSorter));
		else
	...
	public String getCommandSenderName()
	{
		...
		{
			case 1:
			return StatCollector.translateToLocal("entity.SpiderPriest.name");
			case 2:
			return StatCollector.translateToLocal("entity.SpiderZealot.name");
			case 3:
			return StatCollector.translateToLocal("entity.SpiderBishop.name");
			case 4:
			return StatCollector.translateToLocal("entity.SpiderTemplar.name");
			default:
			return StatCollector.translateToLocal("entity.SpiderLoyalist.name");
		}
	}
	...
	*/
	...
	public void onLivingUpdate()
	{
		...
		if (this.getMinionTypeInt() == 4)
		{
			...
			if (!this.worldObj.isRemote && list11 != null && !list11.isEmpty() && this.ticksExisted % (this.getHealth() < this.getMaxHealth() / 2 ? 40 : 160) == 0)
			{
				...
				for (int i1 = 0; i1 < list11.size(); i1++)
				{
					...
					if (entity != null && entity instanceof EntityLivingBase && this.canAttackClass(entity.getClass()) && isClient())
					{
		...
		if (this.getMinionTypeInt() == 1)
		{
			if ((this.ticksExisted % 40 == 0) && (this.entityToHeal != null))
			{
				...
				{
					swingItem();
					this.getLookHelper().setLookPositionWithEntity(this.entityToHeal, 180.0F, getVerticalFaceSpeed());
		...
		else
		{
			...
			if ((list != null) && (!list.isEmpty()))
			{
				for (int i1 = 0; i1 < list.size(); i1++)
				{
					...
					if ((entity != null) && ((entity instanceof EntitySpiderTitan)) && !(entity instanceof EntityCaveSpiderTitan))
					{
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_)
	{
		...
		switch (this.rand.nextInt(5))
		{
			...
			break;
			case 3:playSound("mob.wither.shoot", 1.0F, 3.0F);
			...
			break;
			case 4:this.worldObj.playSoundEffect(this.posX, this.posY, this.posZ, "ambient.weather.thunder", 10000.0F, 0.8F + this.rand.nextFloat() * 0.2F);
			...
			if ((list11 != null) && (!list11.isEmpty()))
			{
				...
				{
					Entity entity = (Entity)list11.get(i1);
					if (((entity instanceof EntitySpiderMinion)) && (entity != null))
					{
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
	{
		...
		if (this.rand.nextInt(this.worldObj.difficultySetting == EnumDifficulty.NORMAL ? 25 : this.worldObj.difficultySetting == EnumDifficulty.HARD ? 2 : 500) == 0)
		{
			switch (this.rand.nextInt(10))
			{
				...
				this.isStrong = true;
				break;
				case 2:addPotionEffect(new PotionEffect(Potion.invisibility.id, Integer.MAX_VALUE, 0, true));
	...
	public boolean isFriendly(Entity entity)
	{
		if (entity == null)
		return false;
		return (entity instanceof EntitySpiderMinion || entity instanceof EntitySpiderTitan) && !(entity instanceof EntityCaveSpiderTitan || entity instanceof EntityCaveSpiderMinion);
	}
}
